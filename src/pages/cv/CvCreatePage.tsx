    ...
    return (
        <>
            <div className="w-full mx-auto my-auto bg-surface p-5 mt-12 border border-gray-200 rounded-sm shadow-xl shadow-surface-elevated">
                <h1 className="font-sans font-semibold text-3xl text-font">Create your CV</h1>
                <form
                ...
                >
                    ...
                    <Button type="submit" className="w-1/2 mx-auto font-semibold text-lg bg-primary-dark-purple hover:bg-hover-dark-purple border-2 border-secondary-light-purple rounded-md py-5 mt-10 cursor-pointer">
