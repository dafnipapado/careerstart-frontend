...
const Header = () => {
    ...
    return (
        <>
            <div className="fixed w-full h-13 top-0 left-0 flex justify-center bg-black z-50">
                <div className="w-[55%] flex justify-end items-center ">
                    <AuthButton/>
                </div>

            </div>
            <header className="fixed w-full h-30 left-0 flex justify-center bg-white px-8 py-4 mt-13 z-50">
